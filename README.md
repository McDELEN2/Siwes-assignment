...
|---|---------|-------------|-----------|-------------|
| 1 | **Conference Ticket Generator** | A form-validation project featuring file upload and accessibility support, letting users generate a personalized conference ticket. | [View Live](#) | [View Code](https://mcdelen2.github.io/Siwes-assignment/conference%20ticket%20generator%20main) |
...
| 3 | **FAQ Accordion** | An accessible, keyboard-navigable FAQ accordion — a common UI pattern for JavaScript and accessibility practice. | [View Live](#) | [View Code](https://mcdelen2.github.io/Siwes-assignment/faq%20accorddion%20main) |
| 4 | **News Homepage** | A responsive news homepage built with CSS Grid and semantic HTML. | [View Live](#) | [View Code](https://mcdelen2.github.io/Siwes-assignment/news%20homepage%20main) |
...
These challenges are based on briefs from [Frontend Mentor](https://www.frontendmentor.io/), used as part of my SIWES training assignments at EDTECH COE.

## Contact

Feel free to reach out or explore the individual project repositories linked above.
